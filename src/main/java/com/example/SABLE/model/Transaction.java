 ...
 *
 * This class is mapped to a database table. JPA (Java Persistence API) manages
 * the
 * lifecycle of this entity: creating table schema (when ddl-auto=update),
 * inserting,
 * updating, and querying rows. We use this entity for persistence only; API
 * request
 * data is received via DTOs (e.g. TransactionRequest) to avoid exposing the
 * entity
 ...
 * - When you call repository.save(entity), JPA either INSERTs a new row or
 * UPDATEs
...
public class Transaction {
    ...
    /**
     * Identifier of the party sending the funds (e.g. account id or wallet
     * address).
     */
    ...
    /**
     * Transfer amount. Must be positive; zero or negative transfers are not
     * allowed.
     ...
     */
       ...
       /**
        * Flag indicating whether this transaction has been successfully recorded
        * on-chain.
        */
       @Column(nullable = false)
